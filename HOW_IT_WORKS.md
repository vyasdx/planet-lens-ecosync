...
- **Personalized insights are generated by Google Gemini 2.5 Flash-Lite** via a server-side proxy
...
4. **Real, production-grade GenAI — not a demo call.** Gemini 2.5 Flash-Lite behind a server-side
