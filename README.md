...
> An AI carbon-footprint copilot — powered by **Google Gemini 2.5 Flash-Lite** — that helps individuals
...
Personalized reduction insights are generated by **Google Gemini 2.5 Flash-Lite**, integrated for
...
| `gemini.js` | Server-side Gemini 2.5 Flash-Lite client: prompt builder, response schema, sanitizer, fallback engine. |
...
- **Real:** device sensors (camera/GPS/motion), live global CO₂ ppm, your logged actions and EcoPoints, your personal footprint from the My Lifestyle form, and **AI insights generated live by Gemini 2.5 Flash-Lite** (with a rule-based fallback).
